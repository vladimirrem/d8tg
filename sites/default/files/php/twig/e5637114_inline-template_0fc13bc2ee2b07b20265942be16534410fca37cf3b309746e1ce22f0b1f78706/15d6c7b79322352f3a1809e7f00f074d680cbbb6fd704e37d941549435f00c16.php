...
/* {# inline_template_start #}<div class="created">By {{ uid }} / {{ created }}</div> */
class __TwigTemplate_e44ac2cbdb72145cdd0c810c654238f3f14377cade63635b79d514bd36057f2b extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}<div class=\"created\">By {{ uid }} / {{ created }}</div>";
    }
